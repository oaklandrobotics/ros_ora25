...
def generate_launch_description():
  pkg_share = get_package_share_directory('ora_slam_toolbox')
  ...
  log_param_change = LogInfo(msg=[
    'The provided params file', params_file, ' does not contain slam_toolbox parameters. Using default params file: ', default_params_file
