...
config_rviz2 = os.path.join(
    get_package_share_directory('zed_robot_integration'), 'rviz2', 'view_config.rviz'
)

# URDF/xacro file to be loaded by the Robot State Publisher node
xacro_path = os.path.join(
    get_package_share_directory('zed_robot_integration'), 'urdf', 'zed_robot_mono.urdf.xacro'
)
